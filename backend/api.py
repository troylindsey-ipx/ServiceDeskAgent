...
class AssistantFnc:
    ...
    @llm.function_tool(description="create a new ticket")
    async def create_ticket(
        ...
        try:
            ...
            return f"Ticket created successfully! Your incident number is {result.inc}. The ticket has been submitted and you will receive updates on the status."
